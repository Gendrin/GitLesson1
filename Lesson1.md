...
![CMD](1.png "Инициализация репозитория через стандартную коммандную строку")

![PS](2.png "Инициализация репозитория через коммандную строку PS")

![PS](3.png "Инициализация репозитория через коммандную строку терминала")
...
![CMD](10.png "Повторно проверяем статус репозитория")

На самом деле это уже не первый, а второй коммит, и проверить это нам поможет команда Log.

![CMD](11.png "Просматриваем коммиты в репозитории")
...
![CMD](12.png "Просматриваем коммиты в репозитории")
...
![CMD](13.png "Просматриваем коммиты в репозитории")
...
![CMD](14.png "Просматриваем коммиты в репозитории")
...
#
![CMD](15.png "Перемещаемся на 1 коммит и обратно")
